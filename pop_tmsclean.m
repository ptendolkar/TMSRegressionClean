...
function [EEG LASTCOM]= pop_tmsclean(EEG, varargin)
    ...
    if (nargin < 9)
        ...
        uilist = { ...
          { 'Style', 'text', 'string', 'Channel number ([ ] means all, very slow!)', 'fontweight', 'bold'  } ...
      ...
      [ ~, ~, ~, structout ] = inputgui( geometry, uilist, ...
       ...
       LASTCOM = sprintf( '[EEG] = pop_tmsclean(EEG, %d, %f, %f, %f, %f, %f, %f, %f)', int32(str2double(structout.chan)),...
                        str2double(structout.lowcut) , str2double(structout.highcut), ...
                        str2double(structout.notch), structout.targevent,...
                        str2double(structout.prestim), str2double(structout.exclude),...
                        str2double(structout.explen));
        ...
        LASTCOM = sprintf( '[EEG] = pop_tmsclean(EEG, %d, %f, %f, %f, %f, %f, %f, %f)\n',  varargin{1}, varargin{2}, varargin{3},...
